...
export const Form = ({setPacientes, pacientes, paciente, setPaciente}) => {
  ...
  const handleSubmit = (e) => {
    ...
    if([nombre, propietario, email, alta, sintomas].includes('')){
      console.log('Error al menos un campo vacio');
      setError(true);
      return;
    }
    setError(false);
    ...
    if(paciente.id){
      ...
      const actualizarPaciente = pacientes.map( item => item.id === paciente.id ? objetoPaciente : item);
    ...
    <div className='md:w-1/2 lg:w-2/5'>
        ...
        >
          ...
          <div className='mb-5'>
            ...
            <textarea 
              id="sintomas" 
              placeholder='Describe los sintomams'
              className='border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md'
              value={sintomas}
