...
export const Patient = ({paciente, setPaciente, eliminarPaciente}) => {
  ...
  const handleDelete = () => {
    const response = confirm('Desea eliminar el valor?');
  ...
  return (
    <div className='mt-5 bg-white shadow-md px-5 py-10 rounded-xl'>
        ...
        <p className='font-bold mb-3 text-gray-700 uppercase'>Fecha de alta: <span className='font-normal normal-case'>{paciente.alta}</span></p>
